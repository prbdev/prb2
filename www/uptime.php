...
# legenda
 $infoBox  = "<table>";
 $infoBox .= "<tr><td class='red'> red </td><td>host is down</td></tr>";
 $infoBox .= "<tr><td class='lightRed'> light red </td><td>host up less than one day</td></tr>";
 $infoBox .= "<tr><td class='lightYellow'> light yellow </td><td>host up less than one week</td></tr>";
 $infoBox .= "<tr><td class='lightGreen'> light green </td><td>host up less than one month</td></tr>";
 $infoBox .= "<tr><td class='lightBleu'> light blue </td><td>host up more than one month</td></tr>";
 $infoBox .= "</table>";
 
 $pageMain .=  "<table><tr>
        <th><a href=?p=$p&group=name&ad=$ad>Host name</a></th>
        <th><a href=?p=$p&ad=$ad>Uptime</a></th>
        <th>Availability</th>
        <th>Status</th>
        <th><a href=?p=$p&group=location&ad=$ad>Location</a></th>
        <th><a href=?p=$p&group=OS&ad=$ad>OS</a></th>
        <th><a href=?p=$p&group=vendor&ad=$ad>Vendor</a></th>
        <th><a href=?p=$p&group=lastPoll&ad=$ad>Last Polled</a></th>
        </tr>";
