...
<b>$info[name]</b> ($info[description])
 ...
 $pageMain .= "<img src='$m->pngURL-8hours.png'>";
 $pageMain .= "<img src='$m->pngURL-1day.png'>";
 $pageMain .= "<img src='$m->pngURL-1week.png'>";
 $pageMain .= "<img src='$m->pngURL-8weeks.png'>";
 $pageMain .= "<img src='$m->pngURL-2years.png'>";
