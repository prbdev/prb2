<?php
 ...
 Class cpq8cpu extends Info {
    ...
    function Update() {
        ...
        $cpu0   = snmpget($this->host, $this->community, ".1.3.6.1.4.1.232.11.2.3.1.1.2.5");
        $cpu1   = snmpget($this->host, $this->community, ".1.3.6.1.4.1.232.11.2.3.1.1.2.6");
        $cpu2   = snmpget($this->host, $this->community, ".1.3.6.1.4.1.232.11.2.3.1.1.2.7");
        $cpu3   = snmpget($this->host, $this->community, ".1.3.6.1.4.1.232.11.2.3.1.1.2.8");
